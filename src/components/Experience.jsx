    ...
    <section id="experience" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#030712]/40 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-extrabold text-white mb-4 tracking-tight">Work History</h2>
            ...
            {experience.map((job, index) => (
              ...
              >
                ...
                <div className={`w-full md:w-1/2 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                  <div className="rounded-2xl glass-card border-slate-800/80 p-6 shadow-xl transition-all duration-300 hover:border-teal-500/20 hover:shadow-2xl hover:shadow-teal-950/10 group relative">
                    ...
                    <div className="pl-3 space-y-4">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-slate-900">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="text-white text-lg font-bold font-display">{job.title}</h3>
                            <p className="text-teal-400 text-sm font-semibold">{job.company}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-4 text-xs font-mono text-slate-400">
                        <div className="flex items-center gap-1.5 bg-slate-950/40 px-2.5 py-1 rounded-md border border-slate-900">
                      ...
                      <div className="space-y-2.5 pt-2">
                        ...
                        <ul className="space-y-2">
                          {job.responsibilities.map((responsibility, i) => (
                            <li 
                              key={i} 
                              className="flex items-start text-slate-400 text-xs sm:text-sm leading-relaxed group/item transition-colors duration-200 hover:text-slate-200"
                            >
                              <span className="text-teal-400 mr-2.5 mt-1 text-[10px] font-bold select-none group-hover/item:scale-125 transition-transform">▹</span>
